...
export function App() {
  ...
  return <>{!opened && <Opening onOpen={open} />}<div className={`site ${!opened ? 'site--locked' : ''}`}>
    ...
    <main>
      ...
      <SaveTheDate />
      <section className="events section-band" id="events"><div className="section-intro" data-reveal="up"><p className="eyebrow">Two chapters, one beginning</p><h2>Our wedding<br /><i>celebrations</i></h2></div><div className="timeline" data-reveal="up"><EventChapter event={config.events.nikah} featured /><EventChapter event={config.events.walima} /></div></section>
      <Countdown />
